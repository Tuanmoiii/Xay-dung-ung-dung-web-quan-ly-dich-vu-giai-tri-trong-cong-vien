...
<input class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border-none bg-gray-100 dark:bg-gray-800 h-full placeholder:text-gray-500 dark:placeholder:text-gray-400 px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal" placeholder="Tìm theo tên, email..." value=""/>
</div>
</label>
</div>
...
<!-- Membership tier filter removed -->
 <a href="create.php">
    <button class="flex cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-primary text-white gap-2 text-sm font-bold leading-normal min-w-0 px-4 hover:bg-primary/90 transition-colors">
...
<td class="p-4"><input class="form-checkbox rounded border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-primary focus:ring-primary/50" type="checkbox"/></td>
...
<?php endforeach; else: ?>
<tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50"><td class="p-6 text-center" colspan="6">Chưa có khách hàng nào.</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
